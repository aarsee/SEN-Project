                ...
                <li id="menu-item-4" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-4 dropdown"><a title="Forums" href="#" data-toggle="dropdown" class="dropdown-toggle">Forums <span class="caret"></span></a>
                    <ul role="menu" class=" dropdown-menu">
                        <li id="menu-item-20" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20">
                            <a title="addforum" href="add-forum.php">Add Forum</a>
                        </li>
...
<header class="wrap-title">
    <div class="container">
        <h1 class="page-title">Add Forum</h1>
...
function topic_validate() 
    {
        ...
        {
                    document.getElementById("err_topic").innerHTML="This Field Cannot be empty !!";
        }
        else if (!isNaN(document.getElementById("topic").value)) 
        {
             document.getElementById("err_topic").innerHTML="Not a Valid Topic";
            //put error message on error division
        }
        else
        {
         document.getElementById("err_topic").innerHTML="";   
        }
    }
  ...
  <div class="panel-body">
    ...
    <form role="form" id="form1" method="post" class="validate" action="insertforum.php">
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
          <input type="text" class="form-control" id="topic" name="topic" onBlur="topic_validate()" required/>  
        </div>
      </div>
      <div id="err_topic" style="color:0000ff"></div>
      <br /><br /><br />
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
        <input type="text" class="form-control" id="description" name="description" onBlur="description_validate()" required />
        </div>
      </div>
      ...
      <div class="form-group">
        <button type="submit" name="submit" class="btn btn-success">Add Forum</button>
