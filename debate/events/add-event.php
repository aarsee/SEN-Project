...
function name_validate() 
    {
        if(document.getElementById("ename").value.length==0)
        {
                    document.getElementById("err_name").innerHTML="This Field Cannot be empty !!";
        }
        else if (!isNaN(document.getElementById("ename").value)) 
        {
...
function description_validate() 
    {
        if(document.getElementById("edescription").value.length==0)
        {
                    document.getElementById("err_d").innerHTML="This Field Cannot be empty !!";
        }
        else if (!isNaN(document.getElementById("edescription").value)) 
        {
 ...
 function venue_validate()
    {
        if(document.getElementById('evenue').value==0)
        {
...
function duration_validate()
    {
        if(document.getElementById('eduration').value==0)
        {
...
function time_validate()
    {
        if(document.getElementById('etime').value==0)
        {
            document.getElementById('err_t').innerHTML="Enter Time";
        }
        else
        {
            var x=document.getElementById('etime').value;
                var atpos=x.indexOf(":");
                var dotpos=x.lastIndexOf(":");
                if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length)
                {
                    document.getElementById('err_t').innerHTML="!! NOT A VALID TIME !!";
                }
                else
                {
 ...
 function final_check()
    {
        ...
        {
            alert("OOPS! YOU DID NOT ENTER CORRECT NAME OF EVENT.");
            return false
        }
        else if(document.getElementById('err_d').innerHTML!="")
        {
            alert("OOPS! YOU DID NOT ENTER CORRECT DESCRIPTION");
            return false
        }
        else if(document.getElementById('err_v').innerHTML!="")
        {
            alert("OOPS! YOU DID NOT ENTER CORRECT VENUE");
            return false
        }
        else if(document.getElementById('err_t').innerHTML!="")
        {
            alert("OOPS! YOU DID NOT ENTER TIME.");
            return false
        }
        else if(document.getElementById('err_dt').innerHTML!="")
        {
            alert("OOPS! YOU DID NOT ENTER DATE.");
            return false
        }
        else if(document.getElementById('err_dr').innerHTML!="")
        {
            alert("OOPS! YOU DID NOT ENTER DURATION.");
            return false
        }
        else
        {
  ...
  <div class="panel-body">
    ...
    <form role="form" id="form1" method="post" action="add-event.php" onSubmit="return final check()">
      
      <div class="form-group" >
        <label for="field-1" class="control-label">Name :</label>
        <br />
        <div class="col-sm-5">
          <input type="text" class="form-control" id="ename" name="ename" onBlur="name_validate()" required/>  
        </div>
      </div>
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
        <input type="text" class="form-control" id="edescription" name="edescription" onBlur="description_validate()" required />
        </div>
      </div>
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
        <input type="text" class="form-control" name="evenue" id="evenue" onBlur="venue_validate()" required/>
        </div>
      </div>
      ...
      <div class="form-group" >
        <label for="field-1" class="control-label">Time : (Format - Hours:Minutes:Seconds)</label>
        <br />
        <div class="col-sm-5">
        <input type="time" class="form-control" name="etime" id="etime" onBlur="time_validate()" required/>
        </div>
      </div>
      ...
      <div class="form-group" >
        <label for="field-1" class="control-label">Duration : ("Number" hours)</label>
        <br />
        <div class="col-sm-5">
        <input type="text" class="form-control" name="eduration" id="eduration"onBlur="duration_validate()" required/>
        </div>
      </div>
      ...
      <div class="form-group" >
        <label for="field-1" class="control-label">Date : (Format - yyyy-mm-dd)</label>
        <br />
        <div class="col-sm-5">
        <input type="text" class="form-control" name="edate" id="edate"onBlur="date_validate()" required/>
        </div>
      </div>
