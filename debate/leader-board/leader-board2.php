...
$connect = mysql_connect('localhost','root','');
	...
	mysql_select_db('debate',$connect);
        ...
        $sql = "update user set u_rating = '$rate' where u_id='$id'";
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-mind-collapse">
            <ul id="menu-mainmenu" class="nav navbar-nav">
                ...
                <li id="menu-item-11" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-11">
                    <a title="Topic" href="leader-board2.php">Leader-Board</a>
                </li>
...
<header class="wrap-title">
    <div class="container">
        <h1 class="page-title">Manage Leaderboard</h1>
    </div>
...
<div class="container">
    ...
    <form role="form" action="leader-board2.php" method="post" onsubmit="Lead.php">
                  <div class="form-group">
                         
                      <h1><font face='Garamond'><strong>Enter the Id and Rank</strong></font></h1><br>
                                    <input type="text" class="form-control" placeholder="DA-IICT ID" name="uid" id="uid" onBlur="id_validate()" required>
                                ...
                                <br>
                                    ...
                                    <input type="number" min="0" class="form-control" placeholder="Rank" name="urating" id="urating">
                                
                
                                
                                <hr>
                                <button type="submit" class="btn btn-primary pull-right" name="leader" id="leader">Submit</button>
