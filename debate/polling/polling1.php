        ...
        <div class="collapse navbar-collapse navbar-mind-collapse">
            <ul id="menu-mainmenu" class="nav navbar-nav">
                ...
                <li id="menu-item-7" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7">
                    <a title="Polling" href="polling1.php">Polling</a>
                </li>
...
while($row = mysql_fetch_array($retval, MYSQL_ASSOC))
{
    ?> 
              ...
              <article class="post">
                ...
                <form action="polling1.php" method="post">
                ...
                <div class="container">
<div class="container">
  <h4>YES (<?php echo $row['p_y']; ?>)</h4>
 <progress value="<?php echo $row['p_y']; ?>" max="20">
</progress>
</div>
<div class="container">
  <h4>NO (<?php echo $row['p_y']; ?>)</h4>
 <progress value="<?php echo $row['p_n']; ?>" max="20">
</progress>
</div>
&nbsp;
&nbsp;
