                    ...
                    <div class="col-md-3 col-sm-6">
                       <article class="mind-features-item hover animated bounceInLeft animation-delay-8">
                           ...
                           <div class="item-content">
                               ...
                               <a href="forums/forums2.php" class="btn btn-success pull-right">View Forum</a>
                               <a href="forums/add-forum.php" class="btn btn-success pull-left">Add Forum</a>
                           </div>
                   ...
                   <div class="col-md-3 col-sm-6">
                       <article class="mind-features-item hover animated bounceInLeft animation-delay-3">
                           ...
                           <div class="item-content">
                               ...
                               <a href="blog/add-blog1.php" class="btn btn-success pull-left">Add Blogs</a>
                           </div>
                       </article> <!-- mind-features-item -->
                   </div>
                   ...
                   <div class="col-md-3 col-sm-6">
                       <article class="mind-features-item hover animated bounceInRight animation-delay-6">
                           ...
                           <div class="item-content">
                               ...
                               <a href="polling/add-polling.php" class="btn btn-success pull-left">Add Polls</a>
                           </div>
                       </article> <!-- mind-features-item -->
                   </div>
                  ...
                  <div class="col-md-7">
                    <section class="home-post">
                        ...
                        <div class="row home-post-footer">
                            <div class="col-md-4">
                                <a href="latestblog2.php" class="btn btn-primary btn-block">Read more</a>
                            </div>
                        </div>
                    </section>
              </div>
