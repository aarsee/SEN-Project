  ...
  <div class="panel-body">
    ...
    <form role="form" id="form1" method="post" class="validate">
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
        <input type="text" class="form-control" name="sq" value="<?php echo $user->u_securityQ ;?>"id="sq" onBlur="usq_validate()" required/>
        </div>
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
        <input type="password" class="form-control" name="sa" value="<?php echo $user->u_securityA ;?>" id="sa" onBlur="usa_validate()" required/>
        </div>
