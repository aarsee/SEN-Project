...
<?php
    ...
    if( isset( $_POST['submit'] ) )
    {
        ...
        $user->update_name($_POST['name'], $_SESSION['u_id']);

        $user->u_aemailID = $_POST['aemail'];
        $user->update_aemail($_POST['aemail'], $_SESSION['u_id']);

        $user->u_securityQ= $_POST['sq'];
        $user->update_securityQ($_POST['sq'],$_SESSION['u_id']);

        $user->u_securityA= $_POST['sa'];
        $user->update_securityA($_POST['sa'], $_SESSION['u_id']);
...
function uname_validate() 
    ...
    {
        if(document.getElementById('aemail').value.length==0)
        {
            document.getElementById('err_aemail').innerHTML="!! PLEASE ENTER AN E-MAIL ID !!";
        }
        else 
            {
                var x=document.getElementById('aemail').value;
                var atpos=x.indexOf("@");
...
function usq_validate()
    {
       if(document.getElementById('sq').value==0)
        {
    ...
    {
       if(document.getElementById('sa').value==0)
        {
...
function final_check()
    {
        ...
        else if(document.getElementById('aemail').value=="")
        {
            alert("OOPS! YOU DID NOT ENTER CORRECT Alternate Email, PLEASE ENTER VALID DATA.");
            return false
        }
        else if(document.getElementById('sq').value=="")
        {
            alert("OOPS! YOU DID NOT ENTER CORRECT Security Question, PLEASE ENTER VALID DATA.");
            return false
        }
  ...
  <div class="panel-body">
    ...
    <form role="form" id="form1" method="post" class="validate">
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
          <input type="text" class="form-control" value="<?php echo $user->u_name ;?>" name="name" id="name" onBlur="uname_validate()" required/>  
        </div>
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
        <input type="text" class="form-control" name="aemail" value=" <?php echo $user->u_aemailID ;?>" id="aemail" onBlur="uaemail_validate()" required/>
        </div>
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
        <input type="text" class="form-control" name="sq" id="sq" value="<?php echo $user->u_securityQ ;?>" onBlur="usq_validate()" required/>
        </div>
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
        <input type="password" class="form-control" name="sa" id="sa" value="<?php echo $user->u_securityA ;?>" onBlur="usa_validate()" required  />
        </div>
      ...
      <div class="form-group">
        <button type="submit" name="submit" class="btn btn-success" onClick="return final_check()">Edit Profile</button>
