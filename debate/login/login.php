...
function id_validate() 
    {
        ...
        else
        {
         ...
         //console.log(data)
         if(data=="0")
            document.getElementById("err_id").innerHTML="Such Id is not registered";
         if(data=="1")
            document.getElementById("err_id").innerHTML=""})
    ...
    {
        if(document.getElementById('err_id').innerHTML == "Such Id is not registered")
        {
            alert("OOPS! Such Id Does not exist .");
            return false;
        }

        else if(document.getElementById('err_id').innerHTML != "")
        {
            alert("OOPS! YOU DID NOT ENTER CORRECT Id, PLEASE ENTER VALID DATA.");
            return false;
        }
        
        else if(document.getElementById("uid").value ==0)
        {
          alert("OOPS! YOU DID NOT ENTER User Id, PLEASE ENTER VALID DATA.");
            return false;   
        }
        else if(document.getElementById('upwd').value == "")
        {
            alert("OOPS! YOU DID NOT ENTER CORRECT Password, PLEASE ENTER VALID DATA.");
            return false;
        }
    }
</script>
                        ...
                        <form role="form" action="check_login.php" method="post">
                            <div class="form-group">
                                <div class="input-group login-input">
                                    ...
                                    <input type="text" class="form-control" placeholder="UserID" name="uid" id="uid" onBlur="id_validate()">
                                </div>
                            <div id="err_id" style="color:0000ff">
                                ...
                                <div class="input-group login-input">
                                    ...
                                    <input type="password" class="form-control" placeholder="Password" name="upwd" id="upwd" onBlur="upwd_validate()" >
                                </div>
                                ...
                                <hr>
                                <button type="submit" class="btn btn-primary pull-right" name="login" id="login" onClick="return final_check()">Login</button>
