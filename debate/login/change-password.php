...
function id_validate() 
    ...
    {
        if(document.getElementById('npwd').value==0)
        {
    ...
    {
        var x=document.getElementById('npwd').value;
        if(document.getElementById('rnpwd').value==0)
        {
             document.getElementById('err_cpwd').innerHTML="Enter Confirm Password";
        }
        else if(document.getElementById('rnpwd').value!=x || document.getElementById('rnpwd').value==0)
        {
            document.getElementById('err_cpwd').innerHTML="Password do not Match";
        }
        else
        {
    ...
    {
        if(document.getElementById('err_pwd').innerHTML!="")
        {
            alert("OOPS! YOU DID NOT ENTER valid Password, PLEASE ENTER VALID DATA.");
            return false
        }
  ...
  <div class="panel-body">
    ...
    <form role="form" id="form1" method="post" class="validate">
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
          <input type="password" class="form-control" name="npwd" id="npwd" onBlur="upwd_validate()" required/>  
        </div>
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
          <input type="password" class="form-control" id="rnpwd" name="rnpwd" onBlur="ucpwd_validate()" required/>  
        </div>
      ...
      <div class="form-group">
        <button type="submit" name="submit" class="btn btn-success" onClick="return final_check()">Change Password</button>
