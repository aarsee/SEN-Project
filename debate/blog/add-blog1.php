                ...
                <li id="menu-item-30" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-30 dropdown"><a title="Blog" href="#" data-toggle="dropdown" class="dropdown-toggle">Blogs <span class="caret"></span></a>
                    <ul role="menu" class=" dropdown-menu">
                        <li id="menu-item-31" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-31">
                            <a title="addblog" href="add-blog1.php">Add a blog</a>
                        </li>
...
function btopic_validate() 
    {
        ...
        {
                    document.getElementById("err_bt").innerHTML="This Field Cannot be empty !!";
        }
        else if (!isNaN(document.getElementById("btopic").value)) 
        {
             document.getElementById("err_bt").innerHTML="Not a Valid Topic";
            //put error message on error division
        }
        else
        {
         document.getElementById("err_bt").innerHTML="";   
        }
    }
...
function bdescription_validate() 
    {
        ...
        else if (!isNaN(document.getElementById("bdescription").value)) 
        {
 ...
 function bcategory_validate()
    {
        if(document.getElementById('bcategory').value==0)
        {
            document.getElementById('err_v').innerHTML="Enter Category";
        }
        else if (!isNaN(document.getElementById("bcategory").value)) 
        {
             document.getElementById("err_v").innerHTML="Not a Valid Category";
            //put error message on error division
        }
        else
        {
  ...
  <div class="panel-body">
    ...
    <form role="form" id="form1" method="post" class="validate">
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-5">
          <input type="text" class="form-control" id="btopic" name="btopic" onBlur="btopic_validate()" required/>  
        </div>
      </div>
      <div id="err_bt" style="color:#F03"></div>
      <br /><br /><br />
      ...
      <div class="form-group" >
        ...
        <br />
        <div class="col-sm-15">
        <textarea name="bdescription" id="bdescription" cols="150" rows="10" onBlur="bdescription_validate()" required></textarea><br />
        </div>
      </div>
      <div id="err_d" style="color:#F03"></div>
      <br /><br /><br />
      ...
      <div id="err_v" style="color:#F03"></div>
      <br /><br /><br />
